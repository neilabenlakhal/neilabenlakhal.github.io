...
- Test the code om your machine and make sure it is working properly

- Run SOAPUI test of several SOAP web services 

- Choose one SOAP web service and test it with SOAPUI then write a client to call it (PHP)

- Push your web service with print screen of your SOAPUI tests to your repository 

Send the following on microsoft teams :

- Link of your web service client (git repository)

- Print screens of SOAPUI test
